...
document.getElementById('m-add-address').addEventListener('click',AaddAddress);
...
function AaddAddress(){
    var address1= prompt('Enter your address',);
    if(address1){
        document.getElementById('m-add-address').innerText= ' ' + address1;
    }
    else{
        alert("Address not added")
    }
...
document.getElementById('orderplaced').addEventListener('click',orderPlaced);
